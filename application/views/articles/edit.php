    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <form role="form" action="<?php echo base_url('articles/postdata'); ?>" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" value="<?php echo $article->filename; ?>" name="datafile"> 
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="articles_categorie_id">
                            ...
                            foreach ($results as $result) {
                                ?>
                                <option value="<?php echo $result->id; ?>" <?php if ($result->id == $article->articles_categorie_id) {
                                echo "selected";
                            } ?>>
...
?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="topic" class="form-control" name="topic" value="<?php echo $article->topic; ?>">
                    </div>
...
<?php echo form_textarea(array('name' => 'description', 'id' => 'description', 'value' => ((isset($article->description)) ? $article->description : ''), 'class' => "ckeditor")); ?>
