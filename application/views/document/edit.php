<!-- Datetime picker -->
<link href="<?php echo base_url('themes/admin') ?>/assets/plugins/datepicker/datepicker3.css" rel="stylesheet">
<script src="<?php echo base_url('themes/admin'); ?>/assets/plugins/datepicker/bootstrap-datepicker.js" type="text/javascript">
</script>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="categorie_id">
                            ...
                            foreach ($results as $result) {
                                ?>
                                <option value="<?php echo $result->id; ?>" <?php if ($result->id == $doc->categorie_id) {
                                echo "selected";
                            } ?>>
...
?>
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">
                            ...
                            <a href="<?php echo base_url('assets/doc_uploads/' . $doc->filename); ?>" target="_blank">(ไฟล์เดิมคลิก)</a>
