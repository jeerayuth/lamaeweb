<!-- Datetime picker -->
<?php echo link_tag('adminlte/assets/plugins/datepicker/datepicker3.css'); ?>
<script src="<?php echo base_url(); ?>adminlte/assets/plugins/datepicker/bootstrap-datepicker.js" type="text/javascript">
</script>
