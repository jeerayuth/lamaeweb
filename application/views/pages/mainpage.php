                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                <thead>
                                    <tr role="row">
                                        <th class="sorting" tabindex="0"  rowspan="1" colspan="1" style="width: 80%;">ชื่อเว็บเพจ</th>                               
                                ...
                                <tbody>
                                    <?php foreach ($query as $row): ?>  
                                        <tr role="row">
                                            ...
                                            <td>
                                                <a class="btn btn-primary btn-xs" href="<?php echo base_url('pages/edit/' . $row->id); ?>" role="button"><i class="fa fa-fw fa-trash"></i> แก้ไขข้อมูล</a>
